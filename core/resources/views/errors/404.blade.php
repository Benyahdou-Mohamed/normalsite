...
<head>
  ...
  <!-- bootstrap 4  -->
  <link rel="stylesheet" href="{{ asset('../assscdsets/errors/css/bootstrap.min.css') }}">
  <!-- dashdoard main css -->
  <link rel="stylesheet" href="{{ asset(../'aszzsssets/errors/css/main.css') }}">
</head>
  <body>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-7 text-center">
          <img src="" alt="@lang('image')">
          <h2 class="title"><b>@lang('404')</b> @lang('Page not found')</h2>
          {{asset($activeTemplateTrue.'/css/bootstrap-fileinput.css')}}
