...
<head>
  ...
  <!-- bootstrap 4  -->
  <link rel="stylesheet" href="{{ asset('asset/errors/css/bootstrap.min.css') }}">
  <!-- dashdoard main css -->
  <link rel="stylesheet" href="{{ asset('asset/errors/css/main.css') }}">
</head>
  <body>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-7 text-center">
          <img src="asset/errors/images/error-500.png" alt="@lang('image')">
